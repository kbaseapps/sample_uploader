...
class Application(object):
    ...
    def __init__(self):
        ...
        self.rpc_service.add(impl_sample_uploader.import_samples_from_NCBI,
                             ...
                             types=[dict])
        self.method_authentication['sample_uploader.import_samples_from_NCBI'] = 'required'  # noqa
        self.rpc_service.add(impl_sample_uploader.generate_OTU_sheet,
                             name='sample_uploader.generate_OTU_sheet',
                             types=[dict])
        self.method_authentication['sample_uploader.generate_OTU_sheet'] = 'required'  # noqa
        ...
        self.rpc_service.add(impl_sample_uploader.link_samples,
        ...
        self.rpc_service.add(impl_sample_uploader.create_data_set_from_links,
                             name='sample_uploader.create_data_set_from_links',
                             types=[dict])
        self.method_authentication['sample_uploader.create_data_set_from_links'] = 'required'  # noqa
